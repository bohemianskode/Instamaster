...
printf "\e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m]\e[0m\e[1;93m Gunakan kredensial yang disimpan\e[0m\n"
else
rm -rf cookie.$user
login_user
fi
...
url="https://i.instagram.com/api/v1/friendships/5419645263/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/1918078581/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/13838992/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/5451786/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/7764951/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/52821870/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/5544119/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/32196219/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/4661600/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/1412790175/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/3329399/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/420319695/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/2787671/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/1472095/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/2143390160/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/799054998/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/2087030852/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/3003741301/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/15749596/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/25980770/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/9290336/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/15277137734/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/177756402/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/7684785/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/48294511/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/7559709/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/1304211734/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/7497978/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/23899823/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/186744830/following/?rank_token=$user_id\_$guid&max_id=$maxid" \

url="https://i.instagram.com/api/v1/friendships/5756510/following/?rank_token=$user_id\_$guid&max_id=$maxid" \
...
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] dapat meningkatkan pengikut Anda sekitar 30 orang dalam 1 jam  \e[0m\n"
...
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Sedang Mencari Tugas Follower %s ..." $celeb
...
data='{"_uuid":"'$guid'", "_uid":"'$username_id'", "user_id":"'$celeb'", "_csrftoken":"'$var2'"}'
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Sedang Mencari Tugas Unfollow %s ..." $celeb
