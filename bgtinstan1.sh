...
string4 = $(openssh rand -hex 32 | cut -c 1-4)
string8 = $(openssh rand -hex 32 | cut -c 1-8)
string12 = $(openssh rand -hex 32 | cut -c 1-12)
string16 = $(openssh rand -hex 32 | cut -c 1-16)
device = "android-$string16"
uuid = $(openssh rand -hex 32 | cut -c 1-32)
phone = "$string8-$string4-$string4-$string4-$string12"
guid = "$string8-$string4-$string4-$string4-$string12"
header = 'Connection: "close", "Accept": "*/*", "Content-type": "application/x-www-form-urlencoded; charset=UTF-8", "Cookie2": "$Version=4" "Accept-Language": "en-US", "User-Agent": "Instagram 10.26.0 Android (18/4.3; 320dpi; 720x1280; Xiaomi; HM 1SW; armani; qcom; en_US)"'
...
login_user() {
    ...
    hmac = $(echo -n "$data" | openssl dgst -sha256 -hmac "$ {
        ig_sig
    }" | cut -d " " -f2)
...
get_story() {
    ...
    printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Downloading story gambar\e[0m\e[1;93m %s/%s\e[0m " $count2 $tot_img
    printf "\e[1;92mDONE!\n\e[0m"
    IFS = $'\n'
...
unfollower() {
    ...
    printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;31m Press \"Ctrl + c\" untuk stop...\e[0m\n"
    sleep 4
    while [[true]]; do
    ...
    if [[$check_unfollow == ""]]; then
    printf "\n\e[1;93m [!] berhenti untuk mencegah pemblokiran\e[0m\n"
    exit 1
    else
        printf "\e[1;92mOK\e[0m\n"
    fi
...
increase_followers() {
    ...
    hmac = $(echo -n "$data" | openssh dgst -sha256 -hmac "$ {
        ig_sig
    }" | cut -d " " -f2)
    printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Sedang Mencari Tugas Followers %s ..." $celeb
    ...
    printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;77m Sabar Antosan 60 Detik.....\e[0m\n"
    sleep 60
    #unfollow
    for celeb in $(cat celeb_id); do
    data = '{"_uuid":"'$guid'", "_uid":"'$username_id'", "user_id":"'$celeb'", "_csrftoken":"'$var2'"}'
...
track_unfollowers() {
    ...
    mv followers2.$user_account followers1.$user_account
        ...
        printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Tidak ada Unfollower\e[0m\n"
    fi
...
get_info() {
    ...
    printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Mendownload Gambar Profil.....\e[0m"
    count = 0
    ...
    printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Simpan:\e[0m\e[1;77m %s/\e[0m\n" $user_account
